    ...
    return (
        <div className="flex-hc-vc">
            <form className="auth-form">
                ...
                <input value={userInfo.username} onChange={onChangeHandle} type="text" placeholder="username" name="username" />
                ...
                <input value={userInfo.phoneNumber} onChange={onChangeHandle} type="phoneNumber" placeholder="Phone Number"
                    name="phoneNumber" />
            </form>
        </div>
    );
